{{TensorPlus[MultScal[-mass, K0Coeff20], MultScal[mass^2/2, M1Coeff20], 
    ...
    MultScal[1/2, SymMult[M1Coeff20, 2, 0][PsiCDe]], 
    MultScal[-1, CurlCDe[M0Coeff]]] == ZeroTensor[{-Spin, -Spin}], 
  TensorPlus[MultScal[mass^2/2, L1Coeff02], 
    MultScal[-2, SymMult[LambdaCDe, 0, 0][L1Coeff02]], 
    MultScal[mass, N0Coeff02], MultScal[1/2, SymMult[L1Coeff02, 0, 2][
      PsiCDe\[Dagger]]], MultScal[-1, CurlDgCDe[L0Coeff]]] == 
  ...
  TensorPlus[MultScal[mass^2/2, K1Coeff11], MultScal[-mass/2, L0Coeff], 
    ...
    MultScal[mass, M0Coeff], MultScal[2/3, SymMult[K1Coeff11, 1, 1][PhiCDe]], 
    MultScal[-1, CurlDgCDe[K0Coeff20]], MultScal[1/2, 
     TwistCDe[K0Coeff00]]] == ZeroTensor[{-Spin, Spin\[Dagger]}], 
  TensorPlus[MultScal[-mass, L0Coeff], MultScal[mass/2, M0Coeff], 
    ...
    MultScal[-1, CurlCDe[N0Coeff02]], MultScal[1/2, TwistCDe[N0Coeff00]]] == 
   ZeroTensor[{-Spin, Spin\[Dagger]}]}, 
 {TensorPlus[MultScal[-1, K0Coeff20], MultScal[mass/2, M1Coeff20], 
    MultScal[1/3, CurlCDe[K1Coeff11]]] == ZeroTensor[{-Spin, -Spin}], 
  TensorPlus[MultScal[-mass/3, K1Coeff11], MultScal[-1, L0Coeff], 
    MultScal[(2*mass)/3, N1Coeff11], MultScal[1/3, CurlCDe[L1Coeff02]]] == 
   ZeroTensor[{-Spin, Spin\[Dagger]}], 
  TensorPlus[MultScal[(-2*mass)/3, K1Coeff11], MultScal[-1, M0Coeff], 
    MultScal[mass/3, N1Coeff11], MultScal[1/3, CurlDgCDe[M1Coeff20]]] == 
   ZeroTensor[{-Spin, Spin\[Dagger]}], 
  TensorPlus[MultScal[-mass/2, L1Coeff02], MultScal[-1, N0Coeff02], 
