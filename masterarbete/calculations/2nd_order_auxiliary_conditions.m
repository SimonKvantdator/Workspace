{{TensorPlus[MultScal[mass/2, K0Coeff00], MultScal[-mass/2, N0Coeff00], 
  ...
  TensorPlus[MultScal[mass^2/2, K1Coeff11], MultScal[-mass/2, L0Coeff], 
    ...
    MultScal[1/2, SymMult[K1Coeff31, 3, 0][PsiCDe]], 
    MultScal[-mass/6, SymMult[L2Coeff13, 0, 3][PsiCDe\[Dagger]]], 
    MultScal[-5/12, SymMult[K2Coeff22, 2, 1][CurlCDe[PhiCDe]]], 
    MultScal[-1, CurlDgCDe[K0Coeff20]], MultScal[-1/6, 
     SymMult[K2Coeff22, 1, 2][CurlDgCDe[PhiCDe]]], 
    MultScal[5/36, SymMult[DivCDe[PhiCDe], 1, 1][K2Coeff22]], 
    MultScal[1/2, TwistCDe[K0Coeff00]], MultScal[-9/4, 
     SymMult[TwistCDe[LambdaCDe], 1, 1][K2Coeff22]], 
  ...
  TensorPlus[MultScal[-mass, L0Coeff], MultScal[mass/2, M0Coeff], 
    ...
    MultScal[-1, CurlCDe[N0Coeff02]], MultScal[-1/6, 
     SymMult[N2Coeff22, 2, 1][CurlCDe[PhiCDe]]], 
    MultScal[-5/12, SymMult[N2Coeff22, 1, 2][CurlDgCDe[PhiCDe]]], 
    MultScal[5/36, SymMult[DivCDe[PhiCDe], 1, 1][N2Coeff22]], 
    MultScal[-9/4, SymMult[TwistCDe[LambdaCDe], 1, 1][N2Coeff22]], 
    MultScal[1/2, TwistCDe[N0Coeff00]], MultScal[1/2, 
     SymMult[N2Coeff22, 2, 2][TwistCDe[PhiCDe]]]] == 
   ZeroTensor[{-Spin, Spin\[Dagger]}], 
  TensorPlus[MultScal[-mass, K0Coeff20], MultScal[mass^2/2, M1Coeff20], 
    ...
    MultScal[-1, CurlCDe[M0Coeff]], MultScal[5/36, 
     SymMult[DivCDe[PhiCDe], 1, 1][M2Coeff31]], 
   ...
   ZeroTensor[{-Spin, -Spin}], TensorPlus[MultScal[mass^2/2, L1Coeff02], 
    ...
    MultScal[5/36, SymMult[DivCDe[PhiCDe], 1, 1][L2Coeff13]], 
    MultScal[mass/6, SymMult[K2Coeff22, 2, 1][PhiCDe]], 
    MultScal[2/3, SymMult[L1Coeff22, 2, 1][PhiCDe]], 
    MultScal[-1/20, SymMult[L2Coeff13, 1, 2][CurlCDe[PsiCDe\[Dagger]]]], 
 ...
 {TensorPlus[MultScal[-mass/3, K1Coeff11], MultScal[-1, L0Coeff], 
  ...
  TensorPlus[MultScal[-1, K0Coeff20], MultScal[mass/2, M1Coeff20], 
   ...
   ZeroTensor[{-Spin, -Spin}], TensorPlus[MultScal[-mass/2, L1Coeff02], 
    MultScal[-1, N0Coeff02], MultScal[1/3, CurlDgCDe[N1Coeff11]], 
  ...
  TensorPlus[MultScal[(2*mass^2)/3, K2Coeff22], MultScal[-mass/3, L1Coeff22], 
    ...
    MultScal[-1, CurlDgCDe[K1Coeff31]], MultScal[3, 
     SymMult[K2Coeff22, 1, 1][PhiCDe]], MultScal[2/3, 
     TwistCDe[K1Coeff11]]] == ZeroTensor[{-Spin, -Spin, Spin\[Dagger], 
     Spin\[Dagger]}], TensorPlus[MultScal[(2*mass^2)/3, L2Coeff13], 
    MultScal[-6, SymMult[LambdaCDe, 0, 0][L2Coeff13]], 
    MultScal[mass, N1Coeff13], MultScal[-1, CurlDgCDe[L1Coeff22]], 
  ...
  TensorPlus[MultScal[-mass, K1Coeff31], MultScal[(2*mass^2)/3, M2Coeff31], 
    MultScal[-6, SymMult[LambdaCDe, 0, 0][M2Coeff31]], 
    MultScal[-1, CurlCDe[M1Coeff22]], MultScal[2, SymMult[M2Coeff31, 1, 1][
      PhiCDe]], MultScal[2, SymMult[M2Coeff31, 2, 0][PsiCDe]], 
  ...
  TensorPlus[MultScal[-mass, L1Coeff22], MultScal[mass/3, M1Coeff22], 
    MultScal[(2*mass^2)/3, N2Coeff22], MultScal[-6, 
     ...
     SymMult[N2Coeff22, 0, 2][PsiCDe\[Dagger]]], 
    MultScal[-1, CurlCDe[N1Coeff13]], MultScal[3, SymMult[N2Coeff22, 1, 1][
      PhiCDe]], MultScal[2/3, TwistCDe[N1Coeff11]]] == 
   ZeroTensor[{-Spin, -Spin, Spin\[Dagger], Spin\[Dagger]}]}, 
 {TensorPlus[MultScal[-1, K1Coeff31], MultScal[(2*mass)/3, M2Coeff31], 
    MultScal[1/2, CurlCDe[K2Coeff22]]] == 
   ZeroTensor[{-Spin, -Spin, -Spin, Spin\[Dagger]}], 
  TensorPlus[MultScal[-mass/4, K2Coeff22], MultScal[-1, L1Coeff22], 
    MultScal[(3*mass)/4, N2Coeff22], MultScal[1/2, CurlCDe[L2Coeff13]]] == 
   ZeroTensor[{-Spin, -Spin, Spin\[Dagger], Spin\[Dagger]}], 
  TensorPlus[MultScal[(-3*mass)/4, K2Coeff22], MultScal[-1, M1Coeff22], 
    MultScal[mass/4, N2Coeff22], MultScal[1/2, CurlDgCDe[M2Coeff31]]] == 
   ZeroTensor[{-Spin, -Spin, Spin\[Dagger], Spin\[Dagger]}], 
  TensorPlus[MultScal[(-2*mass)/3, L2Coeff13], MultScal[-1, N1Coeff13], 
