{{TensorPlus[MultScal[-mass/2, K0Coeff00], MultScal[mass/2, N0Coeff00], 
    MultScal[-mass/6, SymMult[K2Coeff22, 2, 2][PhiCDe]], 
  ...
  TensorPlus[MultScal[mass, L0Coeff], MultScal[-mass/2, M0Coeff], 
    ...
    MultScal[-mass/6, SymMult[M2Coeff31, 3, 0][PsiCDe]], 
  ...
  TensorPlus[MultScal[mass, K0Coeff20], MultScal[-mass^2/2, M1Coeff20], 
   ...
   ZeroTensor[{-Spin, -Spin}], TensorPlus[MultScal[-mass^2/2, L1Coeff02], 
    ...
    MultScal[-mass, N0Coeff02], MultScal[-1/2, SymMult[L1Coeff02, 0, 2][
     ...
     SymMult[DivCDe[PhiCDe], 1, 1][L2Coeff13]], MultScal[-mass/6, 
 ...
 {TensorPlus[MultScal[mass/3, K1Coeff11], L0Coeff, 
  ...
  TensorPlus[MultScal[(2*mass)/3, K1Coeff11], M0Coeff, 
    MultScal[-mass/3, N1Coeff11], MultScal[1/3, SymMult[M2Coeff31, 3, 0][
  ...
  TensorPlus[MultScal[mass, L1Coeff22], MultScal[-mass/3, M1Coeff22], 
 ...
 {TensorPlus[K1Coeff31, MultScal[(-2*mass)/3, M2Coeff31], 
  ...
  TensorPlus[MultScal[(3*mass)/4, K2Coeff22], M1Coeff22, 
    MultScal[-mass/4, N2Coeff22], MultScal[-1/2, CurlDgCDe[M2Coeff31]]] == 
   ZeroTensor[{-Spin, -Spin, Spin\[Dagger], Spin\[Dagger]}], 
