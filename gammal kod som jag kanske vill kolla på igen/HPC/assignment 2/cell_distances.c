 ...
 *   	<= nbr_cells_per_block * 3 * sizeof(fix) + nbr_cells_per_block * 3 *sizeof(fix) + nbr_cells_per_block * NBR_CHARS_PER_LINE * sizeof(char) + 20 * 3465 * sizeof(unsigned int) + (7 + nbr_digits(file_length)) * NBR BINS * sizeof(char)
