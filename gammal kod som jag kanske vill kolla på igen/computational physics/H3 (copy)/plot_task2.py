...
real_psi_x_list = np.fromfile("data/real_psi_x_list_task2.bin") # real_psi_x_list[x_index + x_list_length * time_index], [Å^(-1/2)]
...
p0 = parameters[5] # [] 
d = parameters[6] # wavepacket width [Å]
...
skip = 6 # for not as packed plotting
time_factor = 0.1
...
ax2.set_ylabel(r'$P(p)$ width [eV fs / Å]')
