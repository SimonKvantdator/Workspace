...
plt.plot(data[0::skip,0], data[0::skip,1], '-', label=r'Atom 1')
plt.plot(data[0::skip,0], data[0::skip,2], '-', label=r'Atom 2')
plt.plot(data[0::skip,0], data[0::skip,3], '-', label=r'Atom 3')
