...
plt.plot(data1[::skip,0], data1[::skip,2],'-')
plt.plot(data2[::skip,0], data2[::skip,2],'-')
plt.plot(data3[::skip,0], data3[::skip,2],'-')
plt.plot(data4[::skip,0], data4[::skip,2],'-')
plt.plot(data5[::skip,0], data5[::skip,2],'-')

plt.plot(data6[::skip,0], data6[::skip,3],color='k', linewidth=2.0, linestyle='-')
plt.plot(data6[::skip,0], data6[::skip,3] + data6[::skip,4],color='k', linewidth=2.0, linestyle='--')
plt.plot(data6[::skip,0], data6[::skip,3] - data6[::skip,4],color='k', linewidth=2.0, linestyle='--')
