...
setwd("~/Dropbox/a.Uncanny Valley Projects II/2014-12-26 Re-analyses/Daz shared folder (UV)/TIME CAPSULE for OSF/2.) Analysis/0. Raw data/1B-1C")
...
setwd("~/Dropbox/a.Uncanny Valley Projects II/2014-12-26 Re-analyses/Daz shared folder (UV)/TIME CAPSULE for OSF/2.) Analysis/2. Prepped data/1A")
...
s$like.sd = aggregate( main.rating ~ face, data=l4, FUN=sd )$main.rating  # the NA is for Face 1, the attention-check
...
# how many ratings did each face receive?
table(l5$face)
table(t5$face)
