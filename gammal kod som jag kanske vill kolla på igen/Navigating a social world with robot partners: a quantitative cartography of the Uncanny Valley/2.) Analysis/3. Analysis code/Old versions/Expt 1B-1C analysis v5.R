...
ggsave( filename = paste(Sys.Date(), "fig_5_likeability.pdf", sep="_"),
...
setwd("~/Dropbox/Uncanny Valley Projects II/2014-12-26 Re-analyses/Daz shared folder (UV)/Manuscript/Figures")
ggsave( filename = paste(Sys.Date(), "fig_5_trust.pdf", sep="_"),
...
setwd("~/Dropbox/Uncanny Valley Projects II/2014-12-26 Re-analyses/Daz shared folder (UV)/Manuscript/Figures")
ggsave( filename = paste(Sys.Date(), "fig_5_time.pdf", sep="_"),
