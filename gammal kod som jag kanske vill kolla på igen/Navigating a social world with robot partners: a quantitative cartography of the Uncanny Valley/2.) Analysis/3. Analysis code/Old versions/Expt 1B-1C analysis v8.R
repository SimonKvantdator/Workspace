...
views = aggregate(main.rating ~ face, l, length)$main.rating; mean(views)  # L
views = aggregate(main.rating ~ face, t, length)$main.rating; mean(views)  # T
...
ylab="Likability (-100 to 100)"
half.width = 25
p3 = ggplot(f, aes(x=composite, y=like.mean) ) +
