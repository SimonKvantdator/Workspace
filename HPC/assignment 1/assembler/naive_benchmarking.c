...
// -O0 did nothing fancy as expected
// -O1, I noticed, didn't do anything with the sum variable if we didn't print it afterwards. It speeds things up by not writing to %rbx each iteration.
// -O2 I am unsure why these are so much faster. 
// -O3 
// -Os
// -Og
