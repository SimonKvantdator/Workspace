...
\vtop{
    ...
    \vspace{187mm}
    \if\ThesisType M
	\centerline{\includegraphics[width=0.2\pdfpagewidth]{figures/auxiliary/AvancezChalmersU_black_centered.eps}}
    \fi
    \if\ThesisType B
	\centerline{\includegraphics[width=0.2\pdfpagewidth]{figures/auxiliary/AvancezChalmers_black_centered.eps}}
    \fi
    \vspace{-220mm}
}
